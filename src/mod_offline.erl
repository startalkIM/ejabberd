...
store_packet(From, To, Packet) ->
	?DEBUG("offline start pakcet ~p,~p, ~p ~n",[From,To,Packet]),
		...
		true ->
			...
			NewPacket ->
			 ...
			 %   gen_mod:get_module_proc(To#jid.lserver, ?PROCNAME) !
			    gen_mod:get_module_proc(?MYNAME, ?PROCNAME) !
...
check_store_hint(Packet) ->
    case check_has_body_cdata(Packet) of
    true ->

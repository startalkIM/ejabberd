...
-export([start/2, stop/1, process_local_iq_items/3,
	 ...
	 get_info/5, register_feature/1, unregister_feature/1,
	 register_extra_domain/1, unregister_extra_domain/1,
	 transform_module_options/1, mod_opt_type/1, depends/2]).

-export([register_feature/2, unregister_feature/2,register_extra_domain/2, unregister_extra_domain/2]).
...
unregister_extra_domain(Domain) ->
		  ...
		  [named_table, ordered_set, public]),
    ets:delete(disco_extra_domains, {Domain, ?SERVER_KEY}).

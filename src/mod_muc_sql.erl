...
store_room(LServer, Host, Name, Opts) ->
    ...
    {updated,1} ->
            catch ejabberd_sql:sql_query(LServer, [<<"insert into muc_vcard_info(muc_name, show_name, muc_desc, muc_pic, version) values ('">>,Name, <<"@">>,Host, <<"','新建群组', '欢迎加入', '/file/v2/download/5645fc02eac20176c8a3569d83f3ff7a.png', '1');"/utf8>>]),
            ok;
    _ ->

...
-define(SERVER_KEY, <<"ejabberd">>).

-define(PLATFORM, ejabberd_config:get_option(platform,fun(Plat)-> Plat end, qtalk)).
-define(SERVERTYPE, ejabberd_config:get_option(servertype,fun(Type)-> Type end, all)).
-define(LSERVER, ejabberd_utils:get_host()).
%%-define(DBGFSM, true).
